...
|--|--|--|--|
| *group* | `dynamic` |  :heavy_check_mark: | An array of string literals in which each literal represents a Microsoft Entra principal. See [examples for Microsoft Entra principals](reference-security-principals.md).|
