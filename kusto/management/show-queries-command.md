...
:::moniker range="azure-data-explorer"
* Returns a table containing previously run queries across all databases in thr cluster and their completion statistics. You can use KQL queries to explore the results.
