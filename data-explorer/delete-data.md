...
| Delete a few records based on their contents | - Storage artifacts that contain the deleted records aren't necessarily deleted, but the deleted records can't be recovered (regardless of any retention or recoverability settings)<br />- Use if you need a quick way to delete records | [Use soft delete](#soft-delete) |
