...
* When an update policy with a [transactional policy](kusto/management/update-policy.md#transactional-policy) fails, the retries will fall back to batch ingestion.
