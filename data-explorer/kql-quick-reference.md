...
| [format_datetime](kusto/query/format-datetimefunction.md)  | Returns data in [various date formats](kusto/query/format-datetimefunction#supported-formats.md). | `format_datetime(datetime , format)` |
