...
Dictionary structured JSON contains key-value pairs. Json records undergo ingestion mapping using logical expression in the [JsonPath](kusto/query/jsonpath.md) format. You can ingest data with the following structure:
