...
Azure Data Explorer uses a role-based access control (RBAC) model in which [principals](../kusto/access-control/principals-and-identity-providers.md) get access to resources according to the roles they're assigned.
...
Set, view, and manage these roles in the Azure portal or with [management commands](../security-roles.md).
