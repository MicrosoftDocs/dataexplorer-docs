...
The following example uses the ContosoSales database to show the number of sales for washers and dryers in Canada out of the total sum of sales in 2007.
