...
All visualizations that are created in the context of the [render operator](/kusto/query/render-operator#visualization) are available in dashboard visualizations, along with some [dashboard-specific visuals](dashboard-visuals.md).
