...
1. In the *program.cs* file, update the `eventHubName` constant to the name of your eventhub and update the `connectionString` constant to the connection string you copied from the event hub namespace.
