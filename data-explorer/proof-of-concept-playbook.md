...
1. Write Kusto Queries to query data:
    - If you're migrating from SQL based system, you can use the [SQL to Kusto cheat sheet](/kusto/query/sql-cheat-sheet?view=azure-data-explorer&preserve-view=true) to help you get started.
1. Execute the tests:
    ...
    - You can create [load test using JMeter or Grafana k6](/kusto/query/best-practices?view=azure-data-explorer&preserve-view=true).
    - Record your results in a consumable and readily understandable format.
1. Optimize the queries and cluster:
    - Whether you're writing new KQL queries or converting existing queries from other languages, we recommend checking that your queries follow [Query best practices](/kusto/query/best-practices?view=azure-data-explorer&preserve-view=true).
...
* [Common questions about Azure Data Explorer ingestion](ingestion-faq.yml)
* [Best practices for schema management](/kusto/management/management-best-practices?view=azure-data-explorer&preserve-view=true)
