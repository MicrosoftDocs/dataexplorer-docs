...
Use Kusto [stored functions](/kusto/query/schema-entities/stored-functions) for extracting data from Azure Data Explorer. Learn more at [KQL over TDS](/azure/data-explorer/sql-kql-queries-and-stored-functions).
