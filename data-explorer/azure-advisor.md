...
The SKU recommendation takes into account the current zones definitions of a cluster, and all recommended target SKUs, will either match or improve the Compute zones support of the cluster. Adding more Compute zones does not incur any additional costs.
