...
> [!TIP]
> Using the [`join` operator](kusto/query/joinoperator.md), instead of union, may require a [`hint`](kusto/query/joinoperator.md#supported-parameters) to run it on an Azure Data Explorer native cluster.
