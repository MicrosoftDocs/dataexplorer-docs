...
1. Apply an [update policy](./kusto/management/updatepolicy.md) that converts the byte array into a readable string using the [make_string()](./kusto/query/unicode-codepoints-to-string-function.md) function.
