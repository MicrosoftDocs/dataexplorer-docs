...
|FailureStatus      |`Permanent` or `RetryAttemptsExceeded` indicates that operation has exceeded the retry attempts limit or timespan following a recurring transient error.
