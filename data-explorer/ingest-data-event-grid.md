...
1. Fill out the form with the following information. Table and mapping names are case-sensitive:
   ...
   :::image type="content" source="media/ingest-data-event-grid/data-connection-ingest-properties.png" alt-text="Review and create table and mapping ingestion properties.":::
    ...
    | Mapping | *TestMapping* | The mapping you created in **TestDatabase**, which maps incoming JSON data to the column names and data types of **TestTable**. When not specifying the mapping, the [identity mapping](kusto/management/mappings.md#identity-mapping) is automatically used. |
