---
title: 'Data ingestion without Kusto.Ingest library - Azure Data Explorer'
...
* See [article on ingestion mapping pre-creation](../../management/create-ingestion-mapping-command.md) for more details
