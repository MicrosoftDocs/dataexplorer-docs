...
Using [KustoQueuedIngestClient](https://kusdoc2.azurewebsites.net/docs/api/kusto-ingest-client-reference.html#class-kustoqueuedingestclient) is the recommended native data ingestion mode. Here's why:
