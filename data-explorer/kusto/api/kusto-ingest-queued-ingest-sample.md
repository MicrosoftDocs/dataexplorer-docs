---
title: HowTo -  Data Ingestion with Kusto.Ingest Library - Azure Kusto | Microsoft Docs
description: This article describes HowTo -  Data Ingestion with Kusto.Ingest Library in Azure Kusto.
author: orspod
ms.author: v-orspod
ms.reviewer: mblythe
ms.service: kusto
...
2. Provisions a [JSON column mapping object](https://kusdoc2.azurewebsites.net/docs/controlCommands/tables.html#create-ingestion-mapping) on that table
