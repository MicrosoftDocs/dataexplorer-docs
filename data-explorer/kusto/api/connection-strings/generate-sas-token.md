...
1. Select the storage account for which you'd like to create a SAS token.
...
1. In the **Generate SAS** dialog, specify the **Permissions**, **Start and expiry date/time**, and **Allowed IP addresses**. Then, select **Generate SAS token and URL**
   ...
   A new section will display at the bottom of the dialog, listing the blob SAS token and the blob SAS URL.
