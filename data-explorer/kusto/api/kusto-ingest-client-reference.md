---
title: Kusto.Ingest Reference - Ingest Clients and Ingestion Properties - Azure Kusto | Microsoft Docs
description: This article describes Kusto.Ingest Reference - Ingest Clients and Ingestion Properties in Azure Kusto.
author: orspod
ms.author: v-orspod
ms.reviewer: mblythe
ms.service: kusto
...
|AdditionalProperties | Other properties that will be passed as [Ingestion Properties](https://kusdoc2.azurewebsites.net/docs/controlCommands/dataingestion.html#ingestion-properties) to the ingestion command, as not all the Ingestion Properties are represented in a separate member of this class|
