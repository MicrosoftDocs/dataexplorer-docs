...
|AdditionalProperties | Other properties that will be passed as [Ingestion Properties](../management/data_ingest.md#ingestion-properties) to the ingestion command, as not all the Ingestion Properties are represented in a separate member of this class|
