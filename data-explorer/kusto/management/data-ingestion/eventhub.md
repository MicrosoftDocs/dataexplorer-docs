...
| Tags (Preview) | A list of [tags](../extents-overview#extent-tagging) to associate with the ingested data, formatted as a JSON array string. Note the [performance implications](../extents-overview#performance-notes-1) of using tags. |
