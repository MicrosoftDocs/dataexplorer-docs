...
|*IngestionSource* | `string` | :heavy_check_mark: | The ingestion source. The source can be blob URLs (preview) or a list of blobs returned using [.list blobs](list-blobs.md) command. |
