...
|*IngestionSourceName* | `string` | :heavy_check_mark: | The ingestion source. The source can be a URL, source file, or a list of blobs using the [.list blobs command](list-blobs.md).|
