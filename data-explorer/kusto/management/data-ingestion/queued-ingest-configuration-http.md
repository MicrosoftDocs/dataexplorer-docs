...
The ingestion configuration REST API allows you to programmatically retrieve configuration settings for data ingestion, including storage container URIs, lake folder paths, and ingestion limits. This endpoint is essential for setting up automated ingestion workflows.
...
```json
{
  "containerSettings": {
    ...
    "lakeFolders": [
      {
        "path": "https://msit-onelake.dfs.fabric.microsoft.com/workspace/artifact/Files"
      }
    ],
