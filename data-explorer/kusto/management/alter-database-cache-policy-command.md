...
Changes the database cache policy. To speed up queries, data is cached on processing nodes, SSD, or even in RAM. With the [cache policy](cachepolicy.md), your cluster can describe data artifacts so that important data can take priority.
