...
* Monitoring of followed materialized views should be based on leader cluster. See more details in the [monitoring page](materialized-views-monitoring.md#materialized-views-in-follower-databases).
