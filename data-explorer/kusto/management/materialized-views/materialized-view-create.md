...
|dimensionTables|Array|A dynamic argument which includes an array of dimension tables in the view. See [Query argument](#query-argument)
...
The backfill by move extents option can be useful in 2 main scenarios:
