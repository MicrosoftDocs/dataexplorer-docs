...
while keeping all of its other policies as-is:
...
while keeping all of its other policies unchaged:
...
| EnforcementLevel  | string     | The enforecement level of the rate limit.                                                                     |
