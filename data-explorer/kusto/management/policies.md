...
|:::moniker range="microsoft-fabric" [Mirroring policy](mirroring-policy.md) | Allows you to manage your mirroring policy and mirroring policy operations.:::moniker-end|
