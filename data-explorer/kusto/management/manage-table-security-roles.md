...
> [!NOTE]
>
> * To alter table security roles, you must be an `AllDatabasesAdmin`, a `Database Admin`, or a `Table Admin`.
...
*Action* `table` *ObjectName* *Role* `(` *Principal* [`,` *Principal*...] `)` [`skip-results`] [ *Description* ]
