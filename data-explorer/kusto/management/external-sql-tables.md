...
|*sqlTableName*| string | &check; | The name of the SQL table. If the table is not in the default schema of the SQL database, it should be qualified by the schema name and escaped, like so: `['`*SchemaName*`.`*TableName*`']`.|
