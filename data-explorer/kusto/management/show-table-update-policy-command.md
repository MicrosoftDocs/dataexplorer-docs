...
Show the table update policy. The [update policy](updatepolicy.md) causes data to be automatically appended to a target table whenever new data is inserted into the source table, based on a transformation query that runs on the data inserted into the source table.
