---
title: Create and alter tables in storage - Azure Data Explorer
...
* *Format* - The data format. Any of the [ingestion formats](../../ingestion-supported-formats.md) are supported for querying. Using external table for [export scenario](data-export/export-data-to-an-external-table.md) is limited to the following formats: `CSV`, `TSV`, `JSON`, `Parquet`.
