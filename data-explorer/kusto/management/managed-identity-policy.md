...
| `AutomatedFlows`| Run a [Continuous Export](./data-export/continuous-data-export.md) or [Update Policy](./updatepolicy.md) automated flow on behalf of a managed identity. |
