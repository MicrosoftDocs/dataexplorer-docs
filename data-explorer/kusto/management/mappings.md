...
CSV mapping can be applied on all the delimiter-separated tabular formats: CSV, TSV, PSV, SCSV, SOHsv and TXT (see supported [data formats](../../ingestion-supported-formats.md)).
