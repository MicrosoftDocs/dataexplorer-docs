...
> * [Authorized principals](security-roles.md#table-roles-management): When using the `.create table based-on` command, the current principal is added to the table admins.
