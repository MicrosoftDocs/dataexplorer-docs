...
| **Show schema on a cluster which a large schema** <br> (for example, with more than 100 databases) | [`.show databases schema`](../management/show-schema-database.md) | `.show schema`|
