...
* *Role* is the name of the relevant role.
    ...
    |`unrestrictedviewers`|At the database level only, gives view permission to `admins`, `viewers` and `users` for all tables in the database that have a restricted view policy enabled. |
