...
* Membership checks in Azure Active Directory - this is done very efficiently, so checking membership in tens, or even hundreds of groups is possible, without major impact on the query performance
* The filters, joins etc. applied on the data - the impact of these depend on the complexity of the query
