...
Use this command to turn on or turn off a cluster's [callout policy](calloutpolicy.md) or to add a new, non-existing, callout policy to the array of callout  policies defined for the cluster.
