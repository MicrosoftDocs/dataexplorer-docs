...
|AzMonStream     |N/A     |Azure Monitor [export format to Event Hub](/azure/azure-monitor/platform/stream-monitoring-data-event-hubs#data-formats).  Supported only in Event Hub. |
