...
There is another option to refresh the schema manually by using the command [Clear Cross Cluster Schema Cache](../management/clear-cross-cluster-schema-cache.md).
