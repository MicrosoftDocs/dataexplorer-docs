---
title: Cross-cluster queries and schema changes  - Azure Kusto | Microsoft Docs
description: This article describes Cross-cluster queries and schema changes  in Azure Kusto.
author: orspod
ms.author: v-orspod
ms.reviewer: mblythe
ms.service: kusto
