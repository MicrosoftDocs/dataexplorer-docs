...
It attempts to do a fair round-robin between queries if more than one is running. This method yields the best performance for temporary queries.
...
latencies to give concurrent temporary queries high priority.
