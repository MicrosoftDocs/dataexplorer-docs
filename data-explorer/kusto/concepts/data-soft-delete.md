...
However, if you need to frequently delete records for deduplication or updates, then using [Materialized Views](../management/materialized-views/materialized-view-overview.md) is the recommended approach.
