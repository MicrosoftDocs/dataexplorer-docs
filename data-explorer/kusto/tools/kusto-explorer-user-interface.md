---
title: The Kusto.Explorer user interface
description: Learn about the features of the Kusto.Explorer user interface
author: orspod
ms.author: orspodek
ms.reviewer: alexans
...
[![](./Images/kusto-explorer-user-interface/ke-start.png "ke-start")](./Images/kusto-explorer-user-interface/ke-start.png#lightbox)
...
[![](./Images/kusto-explorer-user-interface/home-tab.png "Kusto.Explorer Home tab")](./Images/kusto-explorer-user-interface/home-tab.png#lightbox)
...
![Kusto.Explorer query menu](./Images/kusto-explorer-user-interface/home-query-menu.png "query-menu")
...
![Kusto.Explorer share section](./Images/kusto-explorer-user-interface/home-share-menu.png "share-menu")
...
![Visualizations menu](./Images/kusto-explorer-user-interface/home-visualizations-menu.png "menu-visualizations")
...
![View menu](./Images/kusto-explorer-user-interface/home-view-menu.png "view-menu")
...
[![](./Images/kusto-explorer-user-interface/file-tab.png "File tab")](./Images/kusto-explorer-user-interface/file-tab.png#lightbox)
...
[![](./Images/kusto-explorer-user-interface/connections-tab.png "Connections tab")](./Images/kusto-explorer-user-interface/connections-tab.png#lightbox)
...
[![](./Images/kusto-explorer-user-interface/view-tab.png "View tab")](./Images/kusto-explorer-user-interface/view-tab.png#lightbox)
...
[![](./Images/kusto-explorer-user-interface/tools-tab.png "Tools tab")](./Images/kusto-explorer-user-interface/tools-tab.png#lightbox)
...
[![](./Images/kusto-explorer-user-interface/monitoring-tab.png "Monitoring tab")](./Images/kusto-explorer-user-interface/monitoring-tab.png#lightbox)
...
[![](./Images/kusto-explorer-user-interface/management-tab.png "Management tab")](./Images/kusto-explorer-user-interface/management-tab.png#lightbox)
...
[![](./Images/kusto-explorer-user-interface/help-tab.png "Help tab")](./Images/kusto-explorer-user-interface/help-tab.png#lightbox)
...
![Connections panel](./Images/kusto-explorer-user-interface/connections-panel.png "connections-panel") 
...
[![](./Images/kusto-explorer-user-interface/advanced-connection-string.png "Advanced connection string")](./Images/kusto-explorer-user-interface/advanced-connection-string.png#lightbox)
...
[![](./Images/kusto-explorer-user-interface/ke-color-scheme.png "Verbosity color scheme")](./Images/kusto-explorer-user-interface/ke-color-scheme.png#lightbox)

## Next steps

* Learn about [running Kusto.Explorer from the command line](kusto-explorer-command-line.md)
* Learn about [managing Kusto.Explorer](kusto-explorer-management.md)
* Learn about [troubleshooting Kusto.Explorer](kusto-explorer-troubleshooting.md)
