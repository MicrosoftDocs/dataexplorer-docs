...
Kusto cluter in order to query it in Power BI - see [Authorization and Roles Based Access Control](/concepts/accesscontrol/principal-roles.md) for details)
...
the [Kusto Query Language](../query/essentials/overview.md). Functions and
