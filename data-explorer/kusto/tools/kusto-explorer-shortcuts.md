...
|<kbd>Ctrl</kbd>+<kbd>E</kbd>|Toggles the appearance of the query editor and result panel in the cycle of: `Query Editor and Results` -> `Query Editor` -> `Query Editor and Results` -> `Results</kbd>|
|<kbd>Ctrl</kbd>+<kbd>Shift</kbd>+<kbd>E</kbd>|Toggles the appearance of the query editor and result panel in the cycle of: `Query Editor and Results` -> `Results` -> `Query Editor and Results` -> `Query Editor</kbd>|
