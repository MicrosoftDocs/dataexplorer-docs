...
1. Reset your configuration settings as necessary, as explained [in this how-to article](https://docs.microsoft.com/visualstudio/deployment/how-to-configure-the-clickonce-trust-prompt-behavior).
...
1. Select **Uninstall**.
   ...
   If this procedure fails to uninstall the application (a known issue with ClickOnce applications), see [this](https://stackoverflow.com/questions/10896223/how-do-i-completely-uninstall-a-clickonce-application-from-my-computer) StackOverflow article that explains how to do it.
