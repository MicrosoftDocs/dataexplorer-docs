...
:::image type="content" source="images/activity-metrics-plugin/activity-metrics-churn-and-retention.png" border="false" alt-text="Table displaying the retention and churn rates specified in the query.":::
...
:::image type="content" source="images/activity-metrics-plugin/activity-metrics-dcount-and-dcount-newvalues.png" border="false" alt-text="Table displaying the distinct values and 'new' values that didn't appear in previous time window specified in the query.":::
