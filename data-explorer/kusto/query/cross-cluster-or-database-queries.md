...
* In [Kusto Explorer](../tools/kusto-explorer.md) the default database is the one selected in the [Connections panel](../tools/kusto-explorer-user-interface.md#connections-panel) and the current cluster is the connection containing that database
