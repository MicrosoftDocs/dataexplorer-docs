...
* Data returned by function *T*, if a table named *T* doesn't exist, but a function named *T* exists - function *T* must take no arguments, and return a tabular result.
