...
:::image type="content" source="media/geo-distance-point-to-line-function/madison-ave-road.png" alt-text="NYC taxi pickups on Madison Ave.":::
...
:::image type="content" source="media/geo-distance-point-to-line-function/lines-folding.png" alt-text="Lines folding.":::
