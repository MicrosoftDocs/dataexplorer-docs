...
The entity can be:
- [let statement](./query_language_letstatement.md) appearing before `restrict` statement. 
...
- Tables or functions that are defined in the database metadata.
...
- Wildcard patterns that can match multiple of [let statements](./query_language_letstatement.md) or tables/functions  
