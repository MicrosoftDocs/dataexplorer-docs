...
usual Azure Log Analytics join operation as, in addition to the "equi-join" part (matching the high-cardinality
...
We can then use Azure Log Analytics's equi-join to compare those bucket IDs.
