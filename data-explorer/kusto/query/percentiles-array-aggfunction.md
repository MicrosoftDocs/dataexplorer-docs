...
|*percentiles*| string or dynamic | &check;| One or more constants that specify the percentiles. *percentiles* can be a comma-separated list of strings or a dynamic array.|
