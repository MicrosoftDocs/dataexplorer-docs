...
description: Learn how to use the fork operator the run multiple consumer operators in parallel.
ms.reviewer: alexans
ms.topic: reference
ms.date: 12/12/2022
...
* A name, given by the `name` argument or by using [`as`](asoperator.md) operator will be used as the name to the result tab in [`Kusto.Explorer`](../tools/kusto-explorer.md) tool.
