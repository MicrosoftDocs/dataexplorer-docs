...
and the [isnotnull()](../isnotnullfunction.md) function for numeric types 
...
> [!Note]
> In EngineV2, null comparison expression returned a boolean results, in EngineV3 it returns "null". 
