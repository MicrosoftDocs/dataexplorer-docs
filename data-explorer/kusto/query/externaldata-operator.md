...
> [!NOTE]
> The `externaldata` operator supports Shared Access (SAS) key, Account key and Aad Token authentication methods. See [Storage authentication methods](../api/connection-strings/storage-authentication-methods.md).
