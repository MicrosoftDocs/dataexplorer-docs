...
> [!NOTE]
> H3 Cell polygon edges are straight lines and aren't geodesics. If H3 Cell polygon is part of some other calculation, consider densifying it with [geo_polygon_densify()](geo-polygon-densify-function.md).
