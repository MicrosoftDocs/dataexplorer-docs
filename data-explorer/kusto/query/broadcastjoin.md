...
In order to estimate the size of the left side of the join, you can run the following query and it will output the estimated size of the left side in bytes:
