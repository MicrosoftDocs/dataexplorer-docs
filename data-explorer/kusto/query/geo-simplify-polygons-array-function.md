...
description: This article describes geo_simplify_polygons_array() in Azure Data Explorer.
...
Simplifies polygons by replacing nearly straight chains of short edges with a single long edge, while ensuring mutual boundaries consistency related to each other, on Earth.
...
The following example simplifies polygons with mutual borders (USA states), by removing vertices that are within 100 meters distance from each other.
