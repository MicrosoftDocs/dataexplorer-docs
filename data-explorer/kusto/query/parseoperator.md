...
In regex mode, parse will translate the pattern to a regex. Use [regular expressions](re2-library.md) to do the matching, and use numbered captured groups that are handled internally. For example:
