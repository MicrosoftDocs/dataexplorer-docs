...
|[ipv4_is_in_range()](ipv4-is-in-rangefunction.md)|Checks if IPv4 string address is in IPv4-prefix notation range.|
...
|[ipv4_netmask_suffix](ipv4-netmask-suffixfunction.md)|Returns the value of the IPv4 netmask suffix from IPv4 string address.|
