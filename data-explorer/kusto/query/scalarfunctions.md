...
|[ipv6_is_in_range()](ipv6-is-in-range-function.md)|Checks if IPv6 string address is in IPv6-prefix notation range.|
|[ipv6_is_in_any_range()](ipv6-is-in-any-range-function.md)|Checks if IPv6 string address is any of the IPv6-prefix notation ranges.|
