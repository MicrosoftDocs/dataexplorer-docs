...
|[punycode_from_string()](punycode_from_string.md)| Encodes domain name to Punycode form.|
|[punycode_to_string()](punycode_to_string.md)| Decodes domain name from Punycode form.|
