...
| *OutputSchema* | The names and types of the expected columns of the `cosmosdb_sql_request` plugin output. Use the following syntax: `(` *ColumnName* `:` *ColumnType* [`,` ...] `)` <br> `**Specifying this argument is highly recommended because it enables multiple query optimizations.**` | Optional |
