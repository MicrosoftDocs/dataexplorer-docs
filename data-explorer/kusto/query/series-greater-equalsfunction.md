---
title: series_greater_equals() - Azure Kusto | Microsoft Docs
description: This article describes series_greater_equals() in Azure Kusto.
author: orspod
ms.author: v-orspod
ms.reviewer: mblythe
ms.service: kusto
...
Calculates the element-wise greater or equal [ `>=` ] logic operation of two numeric series inputs.
