...
See an example of how to add a percentage calculation to your results in the [tutorial](/azure/data-explorer/kusto/query/tutorials/learn-common-operators#calculate-percentages) tutorial.
