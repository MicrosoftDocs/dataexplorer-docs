...
|--|--|--|--|
|*EntitySpecifiers*|string|&check;|One or more comma-separated entity specifiers. The possible values are:<br/>
* An identifier defined by a let statement as a tabular view<br/>
* A table or function reference, similar to one used by a union statement<br/>
* A pattern defined by a pattern declaration<br/>|
