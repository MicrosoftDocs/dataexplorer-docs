...
:::image type="content" source="media/plugin/sample-table-to-unpack-bag.png" alt-text="A screenshot of the SalesDynamic table with the customer properties column highlighted":::
