...
| extend pValue=welch-test(m1,v1,c1,m2,v2,c2)
...
`welch-test(`*mean1*`, `*variance1*`, `*count1*`, `*mean2*`, `*variance2*`, `*count2*`)`
...
From [Wikipedia](https://en.wikipedia.org/wiki/Welch%27s-t-test):
