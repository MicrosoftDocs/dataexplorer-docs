...
`in`           |Equals to one of the elements       |[see here](query_language_inoperator.md)
`!in`          |Not equals to any of the elements   |[see here](query_language_inoperator.md)

**Comment regarding the modulo operator**

The modulo of two numbers always returns in Azure Log Analytics a "small non-negative number".
