...
* [**Regex**](#regex): Extraction based on [regular expressions](re2-library.md).
...
|*RegexPattern*|string||A [regular expression](re2-library.md) containing two capturing groups exactly. The first group represents the key name, and the second group represents the key value.|
