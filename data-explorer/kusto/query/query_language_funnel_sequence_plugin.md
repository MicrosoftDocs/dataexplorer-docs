...
The following query looks on the table StormEvents (wheather statistics for 2007) and shows what event happens before/after all Tornado events occured in 2007.
