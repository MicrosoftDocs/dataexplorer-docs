...
Our example database has a table called `StormEvents`. we want to find out how large the table is. So we'll insert its content into an operator that counts the rows in the table.
