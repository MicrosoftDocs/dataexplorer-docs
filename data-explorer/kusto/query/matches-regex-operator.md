...
| *expression* | scalar | &check; | The [regular expression](re2-library.md) used to filter. The maximum number of regex groups is 16. The regular expression syntax supported by Kusto is that of the [re2 library](re2-library.md). |
