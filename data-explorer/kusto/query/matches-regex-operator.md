...
| *expression* | scalar | &check; | The [regular expression](regex.md) used to filter. The maximum number of regex groups is 16. The [regular expression](regex.md) syntax supported by Kusto is that of the RE2 library. |
