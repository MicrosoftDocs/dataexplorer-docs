...
Filters a record set based on a case-sensitive [regular expression](re2-library.md) value.
...
| *expression* | scalar | &check; | The [regular expression](re2-library.md) used to filter. The maximum number of regex groups is 16. The [regular expression](re2-library.md) syntax supported by Kusto is that of the RE2 library. |
