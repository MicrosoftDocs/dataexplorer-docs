...
|Data ingestion into a table             |`.ingest`, `.set`, `.append`, `.set-or-append` (see [Data Ingestion](./dataingestion.md) for details).)
...
Requires [Database viewer permission](https://kusdoc2.azurewebsites.net/docs/concepts/principal-roles.html).
...
Requires [Database user permission](https://kusdoc2.azurewebsites.net/docs/concepts/principal-roles.html).
...
Requires [Database  admin permission](https://kusdoc2.azurewebsites.net/docs/concepts/principal-roles.html).
...
Requires [Table admin permission](https://kusdoc2.azurewebsites.net/docs/concepts/principal-roles.html).
...
The command requires [Database admin permission](https://kusdoc2.azurewebsites.net/docs/concepts/principal-roles.html).
...
**Notes:** 
- Requires [Database admin permission](https://kusdoc2.azurewebsites.net/docs/concepts/principal-roles.html)
- Modification of the table is also allowed to [Database user](https://kusdoc2.azurewebsites.net/docs/concepts/principal-roles.html) who originally created the table 
