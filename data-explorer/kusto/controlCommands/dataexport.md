...
* **Client-side export**: Several tools that provide the ability
  ...
  * [Kusto.WebExplorer](https://kusdoc2.azurewebsites.net/docs/tools/kusto-webexplorer.html)
  * [Lens Explorer](https://kusdoc2.azurewebsites.net/docs/tools/lens.html)
...
* **Service-side import (pull)**: Kusto also supports the ability to execute
  ...
  See [data ingestion](dataingestion.md) for a detailed
