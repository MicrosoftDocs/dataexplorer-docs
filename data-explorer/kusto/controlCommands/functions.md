...
- Modification of the function is also allowed to [Database user](https://kusdoc2.azurewebsites.net/docs/concepts/principal-roles.html) who originally created the function
...
Removes an existing function from the database metadata. 

**Notes:** 
- If function does not exist - no error is returned, and output returned is an empty set.
- Requires [Database admin permission](https://kusdoc2.azurewebsites.net/docs/concepts/principal-roles.html).
- Deletion of the function is also allowed to [Database user](https://kusdoc2.azurewebsites.net/docs/concepts/principal-roles.html) who originally created the function  
