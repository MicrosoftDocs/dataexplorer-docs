...
> [!NOTE]
> * Use the native function [geo_info_from_ip_address()](../query/geo-info-from-ip-address.md) instead of the function described in this document. The native function provides the same functionality and is better for performance and scalability. This document is provided for reference purposes only.
