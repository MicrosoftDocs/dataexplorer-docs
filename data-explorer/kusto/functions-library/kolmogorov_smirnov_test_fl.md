---
title: kolmogorov_smirnov_test_fl() - Azure Data Explorer
description: This article describes the kolmogorov_smirnov_test_fl() user-defined function in Azure Data Explorer.
author: orspod
ms.author: orspodek
...
ms.date: 07/20/2021
---
# kolmogorov_smirnov_test_fl()

The function `kolmogorov_smirnov_test_fl()` performs the [Kolmogorov Smirnov Test](https://en.wikipedia.org/wiki/Kolmogorov%E2%80%93Smirnov_test).

> [!NOTE]
> * `kolmogorov_smirnov_test_fl()` is a [UDF (user-defined function)](../query/functions/user-defined-functions.md). For more information, see [usage](#usage).
> * This function contains inline Python and requires [enabling the python() plugin](../query/pythonplugin.md#enable-the-plugin) on the cluster.

## Syntax

`T | invoke kolmogorov_smirnov_test_fl()(`*data1*`,` *data2*`,` *test_statistic*`,`*p_value*`)`
...
`kolmogorov_smirnov_test_fl()` is a user-defined [tabular function](../query/functions/user-defined-functions.md#tabular-function), to be applied using the [invoke operator](../query/invokeoperator.md). You can either embed its code in your query, or install it in your database. There are two usage options: ad hoc and persistent usage. See the below tabs for examples.
...
```kusto
let kolmogorov_smirnov_test_fl = (tbl:(*), data1:string, data2:string, test_statistic:string, p_value:string)
{
...
kolmogorov_smirnov_test_fl(tbl:(*), data1:string, data2:string, test_statistic:string, p_value:string)
{
    let kwargs = pack('data1', data1, 'data2', data2, 'test_statistic', test_statistic, 'p_value', p_value);
    let code =
        'from scipy import stats\n'
