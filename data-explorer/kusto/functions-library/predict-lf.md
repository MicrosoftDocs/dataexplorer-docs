...
The function `predict_lf()` predicts (a.k.a. scores) using an existing trained ML model that was built using [Scikit-learn](https://scikit-learn.org/stable/), serialized to string and saved in a standard ADX table.
