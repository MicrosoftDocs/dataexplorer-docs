...
| lookback | `timespan` | Time span limiting the period of time in which duplicates are expected. See [Lookback period](../management/materialized-views/materialized-view-create.md#lookback-period). |
