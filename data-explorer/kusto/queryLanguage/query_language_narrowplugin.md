...
The following example shows an easy way to read the output of the Azure Log Analytics
...
0    | ProductVersion                      | Azure Log AnalyticsRelease_2017.03.13.2
0    | FailedIngestOperations              | 0
0    | FailedMergeOperations               | 0
0    | MaxExtentsInSingleTable             | 64
0    | TableWithMaxExtents                 | Azure Log AnalyticsMonitoringPersistentDatabase.Azure Log AnalyticsMonitoringTable
