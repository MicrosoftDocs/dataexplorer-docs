...
Concept of this plugin is similar to [activity_metrics plugin](./query_language_activity_metrics_plugin.md), but focuses on `New Users`.
...
[activity_metrics plugin](./query_language_activity_metrics_plugin.md) documentation.
