...
* AutoCluster is largely based on the Seed-Expand algorithm from the following paper: \[ [Algorithms for Telemetry Data Mining using Discrete Attributes](http://www.scitepress.org/DigitalLibrary/PublicationsDetail.aspx?ID=d5kcrO+cpEU=&t=1) \], full text link: \[[ pdf ](./images/queries/ICPRAM17telemetry.pdf)\]. 
