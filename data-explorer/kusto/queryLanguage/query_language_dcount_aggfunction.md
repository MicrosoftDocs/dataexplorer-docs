...
* *Accuracy*, if specified, controls the balance between speed and accuracy (see Note).
    ...
    * `3` = extra accurate and slowest calculation; about 0.28% error.
...
<p><img src="~/queryLanguage/images/aggregations/dcount.png"></p>
...
<p><img src="~/queryLanguage/images/aggregations/hll-error-distribution.png"></p>
