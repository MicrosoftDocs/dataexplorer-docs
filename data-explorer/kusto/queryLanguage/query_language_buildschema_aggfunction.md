...
They are equivalent to a subset of the TypeScript type annotations, encoded as an Azure Log Analytics dynamic value. In Typescript, the example schema would be:
