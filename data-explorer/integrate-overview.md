...
* **Ingestion type supported:** Batching
* **Use cases:** Data orchestration
* **Documentation:** [Microsoft Logic Apps and Azure Data Explorer](/kusto/tools/logicapps?view=azure-data-explorer&preserve-view=true)
...
* **Underlying SDK:** [.NET](/kusto/api/netfx/about-the-sdk?view=azure-data-explorer&preserve-view=true)
...
* **Underlying SDK:** [Go](/kusto/api/golang/kusto-golang-client-library?view=azure-data-explorer&preserve-view=true)
...
* **Ingestion type supported:** Batching
* **Use cases:** Logs
* **Underlying SDK:** [Python](/kusto/api/python/kusto-python-client-library?view=azure-data-explorer&preserve-view=true)
...
* **Documentation:** [Kusto Query Language setup and usage for the Monaco editor](/kusto/api/monaco/monaco-kusto?view=azure-data-explorer&preserve-view=true) - The Kusto Query Language editor that can be embedded in web and electron based applications.
  * [Kusto Query Language plugin](https://github.com/Azure/monaco-kusto) - Access the Kusto Query Language editor plugin.
  * [Embedding the Azure Data Explorer web UI](/kusto/api/monaco/host-web-ux-in-iframe?view=azure-data-explorer&preserve-view=true) - The Azure Data Explorer web UI can be embedded in an iframe and hosted in third-party websites.
...
* **Documentation:** [Sync Kusto](/kusto/tools/synckusto?view=azure-data-explorer&preserve-view=true)

### Web UI

Azure Data Explorer provides a web experience that enables you to connect to your Azure Data Explorer clusters and write, run, and share [Kusto Query Language (KQL)](/kusto/query/index?view=azure-data-explorer&preserve-view=true) commands and queries
