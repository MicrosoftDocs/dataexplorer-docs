...
> * If streaming is not enabled for the cluster, the option to select **Batching time** appears. The default [batching time](kusto/management/batchingpolicy.md) is five minutes, meaning a batch will be sealed after a maximum of five minutes.
