...
This functionality is especially valuable for users who manage multiple clusters across different user accounts or Azure AD directories. It removes the need to repetitively sign in and sign out, or switch directories, and allows you to seamlessly move between clusters associated with different credentials within a unified interface.
