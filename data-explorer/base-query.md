...
1. Enter a **Variable name** to be used as reference to this base query.  
    ...
    :::image type="content" source="media/base-query/create-base-query.png" alt-text="Screenshot of create base query in Azure Data Explorer dashboards." lightbox="media/base-query/create-base-query_small.png":::
