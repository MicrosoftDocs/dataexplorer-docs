...
1. In the lefthand pane of your Azure Data Explorer cluster, search for *metrics*.
...
To get started using Azure Metrics Explorer, see [Metrics Explorer](/azure/azure-monitor/platform/metrics-getting-started).
...
The cluster metrics track the general health of the cluster. This includes resource and ingestion utilization and responsiveness.
...
For an alphabetical list of Azure Data Explorer metrics and all Azure Monitor metrics, see [supported Azure Data Explorer cluster metrics](/azure/azure-monitor/platform/metrics-supported#microsoftkustoclusters).
