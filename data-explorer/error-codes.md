...
|Error message                                 |Description                                           |Permanent/Transient|
|---|---|---|
|Stream_InputStreamTooLarge                        |The total size of the input data or a single field in the data is too large. HRESULT: 0x80DA0009<br>For more information about the size limit for ingestion of the `string` data type, see [The string data type](/azure/data-explorer/kusto/query/scalar-data-types/string). |Permanent          |
