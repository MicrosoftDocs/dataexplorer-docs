...
1. Fill out the following routing settings:
    ...
    | Mapping | *TestMapping* | The [mapping](kusto/management/mappings.md) you created in **testdb**, which maps incoming data to the column names and data types of **testdb**. When not specifying the mapping, the [identity mapping](kusto/management/mappings.md#identity-mapping) is automatically used. |
    | | |
