...
- **Automated testing**: In general, the Kusto emulator is more suited to automated testing than the free cluster.  It is faster to provision, can run tests faster with *volatile* databases and doesn't require any Azure principal to setup.
