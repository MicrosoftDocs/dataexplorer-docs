...
1. In the **Outbound settings** pane, fill out the following fields:
    ...
    | Source NAT subnet | Cluster virtual network's subnets | One of the cluster virtual network's subnet. <br> **You can't choose a delegated subnet as a Source NAT.**
