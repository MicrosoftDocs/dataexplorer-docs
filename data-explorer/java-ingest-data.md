...
[Management commands](/kusto/management/commands), such as [`.drop`](/kusto/management/drop-function) and [`.create`](/kusto/management/create-function), are executed by calling `execute` on a `com.microsoft.azure.kusto.data.Client` object.
