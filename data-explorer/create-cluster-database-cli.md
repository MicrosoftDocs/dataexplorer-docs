...
1. Create your database by using the following command:
   ...
   | resource-group | *testrg* | The resource group name where the cluster will be created. |
   | read-write-database | *P365D* *P31D* | The type of the database. Parameters: soft-delete-period: Signifies the amount of time that data will be kept available to query. See [retention policy](kusto/management/retentionpolicy.md) for more information. hot-cache-period: Signifies the amount of time that data will be kept in cache. See [cache policy](kusto/management/cachepolicy.md) for more information. location: The location where the database will be created |
