...
|--|--|
| [Create an app to get data using queued ingestion](kusto/api/get-started/app-batch-ingestion.md)| New article. Describes how to create an app to get data using queued ingestion of the Kusto client libraries.|
