...
| - [Scalar function types at a glance](/azure/data-explorer/kusto/query/scalar-functions?view=azure-data-explorer&preserve-view=true) | Updated article. Added the new geospatial functions to the table. |
...
| [Splunk to Kusto cheat sheet](/azure/data-explorer/kusto/query/splunk-cheat-sheet?view=azure-data-explorer&preserve-view=true) | Updated articles. Added timechart Splunk to Kusto comparison. |
