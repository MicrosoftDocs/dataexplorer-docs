...
For more information on Azure Data Explorer principal roles, see [role-based access control](kusto/management/access-control/role-based-authorization.md). For managing security roles, see [security roles management](kusto/management/security-roles.md).
