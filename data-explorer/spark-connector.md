...
> [!NOTE]
> Although some of the examples in this article refer to an [Azure Databricks](/azure/databricks/) Spark cluster, Azure Data Explorer Spark connector doesn't take direct dependencies on Databricks or any other Spark distribution.
...
> [!TIP]
> Spark 2.3.x versions are also supported, but you might need to change some dependencies in pom.xml.
