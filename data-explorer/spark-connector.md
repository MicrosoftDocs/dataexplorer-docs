...
> [!NOTE]
> Although some of the examples below refer to an [Azure Databricks](https://docs.microsoft.com/azure/databricks/) Spark cluster, Azure Data Explorer Spark connector does not take direct dependencies on Databricks or any other Spark distribution.
