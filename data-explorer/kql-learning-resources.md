...
For more information on KQL, see [KQL overview](/kusto/query/index).
...
* [Tutorial: Create geospatial visualizations](/kusto/query/tutorials/create-geospatial-visualizations)
