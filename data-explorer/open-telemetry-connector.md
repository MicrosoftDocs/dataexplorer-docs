...
> [!NOTE]
> The designated principal must have *Data Ingestor* role-based access control. For more information, see [role-based access control](kusto/management/access-control/role-based-authorization.md).
