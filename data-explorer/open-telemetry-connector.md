...
> [!NOTE]
> The designated principal must have an *ingestor* role. For more information, see [role-based access control](kusto/management/access-control/role-based-authorization.md).
