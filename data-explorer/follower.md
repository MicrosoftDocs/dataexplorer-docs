...
Managing read-only database permission is the same as for all database types. See [Manage database permissions in the Azure portal](manage-database-permissions.md).
