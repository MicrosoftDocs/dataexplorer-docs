...
| [**ADX to Apache Spark**](spark-connector.md) | ** CHECK**  | ** CHECK** | Batching, streaming| Move data across Azure Data Explorer and Spark clusters to build fast and scalable applications targeting data driven scenarios |
