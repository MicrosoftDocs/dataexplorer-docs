...
> [!TIP]
> You can navigate to other tutorials from the query editor window. Select the **ellipsis button** (...) > **Open** > **Open tutorials** and then choose the specific tutorial you want to explore.
>
