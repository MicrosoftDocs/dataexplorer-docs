...
* Create a cluster and database that includes the StormEvents sample data. For more information, see [Quickstart: Create an Azure Data Explorer cluster and database](create-cluster-database-quickstart.md) and [Ingest sample data into Azure Data Explorer](ingest-sample-data.md).
