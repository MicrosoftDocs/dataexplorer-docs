...
> [!NOTE]
> The query editor only supports T-SQL `SELECT` statements and doesn't support DDL commands, such as `CREATE`, `ALTER`, or `DROP`. For more information, see [T-SQL in Kusto vs. Microsoft SQL Server](t-sql-limitations.md).
