...
* Logstash version 8.7.0 or higher [Installation instructions](https://www.elastic.co/guide/en/logstash/current/installing-logstash.html). Pay extra attention to the license note, downloading the *oss* package.
