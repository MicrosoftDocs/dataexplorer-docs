...
|-creationTimePattern      |string  |When set, is used to extract the CreationTime property from the file or blob path. See [How to ingest data with time ingested](#how-to-ingest-data-with-time-ingested) |Optional  |
