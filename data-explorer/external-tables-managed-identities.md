...
An [external table](azure/data-explorer/kusto/query/schema-entities/externaltables) is a schema entity that references data stored outside the Azure Data Explorer database.
