...
For more information, see [Mapping transformations](/kusto/management/mappings#mapping-transformations).
...
* [Set up your development environment to use Kusto client libraries](/kusto/api/get-started/app-set-up)
